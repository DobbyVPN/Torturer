...
def emit_command_diagnostics(result: CommandResult) -> None:
    ...
    The slice needs captured text for machine-readable checks, but a successful
    command must not become diagnostically silent in hosted CI. Labels go to
    stderr; child stdout and stderr are written unchanged to their
